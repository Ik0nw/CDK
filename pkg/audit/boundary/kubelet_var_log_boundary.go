//go:build !no_kubelet_var_log_boundary
// +build !no_kubelet_var_log_boundary
...
func (p VarLogEscape) Desc() string {
	...
	buffer.WriteString("Usage: cdk run kubelet-var-log-boundary /root/targetfile-to-read")
