//go:build !no_k8s_secret_sweep
// +build !no_k8s_secret_sweep
...
func (p K8sSecretsDumpS) Desc() string {
	return "try to dump K8s secret in multiple ways, usage: cdk run k8s-secret-sweep (auto|<service-account-token-path>)"
}
