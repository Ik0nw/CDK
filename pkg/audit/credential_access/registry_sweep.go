...
func (p RegistryBruteS) Desc() string {
	return "To container image registry, brute force the accounts and passwords cracking. Usage: ./cdk registry-sweep <registry-url> <username|file> <password|file>. Example: ./cdk registry-sweep https://index.docker.io/ root,admin /tmp/passwordfile."
}
...
func init() {
	...
	plugin.RegisterExploit("registry-sweep", exploit)
}
