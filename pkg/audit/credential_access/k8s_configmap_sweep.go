//go:build !no_k8s_configmap_sweep
// +build !no_k8s_configmap_sweep
...
func (p dumpK8sConfigmapS) Desc() string {
	return "try to dump K8s configmap in multiple ways, usage: cdk run k8s-configmap-sweep (auto|<service-account-token-path>)"
}
