//go:build !no_k8s_cronjob_sensor
// +build !no_k8s_cronjob_sensor
...
func (p K8sCronJobDeployS) Desc() string {
	return "create cronjob with user specified image and cmd. Usage: cdk run k8s-cronjob-sensor (default|anonymous|<token-path>) (min|hour|day|<cron-expr>) <image> <args>"
}
